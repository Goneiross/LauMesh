...
void app_main(){
    ...
    xTaskCreatePinnedToCore(&test,"test",2048,NULL,3,NULL,0);
    xTaskCreatePinnedToCore(&I2cMasterInit,"I2cMasterInit",2048,NULL,4,NULL,0);
    //xTaskCreatePinnedToCore(&I2CSalve1Init,"I2CSlave1Init",1024,NULL,0,NULL,1);
    //xTaskCreatePinnedToCore(&I2cTest,"I2Ctest",1024,NULL,0,NULL,1);
}
